...
export default function PrivacyContent() {
  return (
    <>
      ...
      <p>
        <strong>MediTime</strong> est une application web destinée à faciliter
        la gestion des traitements médicamenteux. Elle permet de créer des
        calendriers personnalisés, de recevoir des rappels, et de partager les
        plannings avec des proches ou des professionnels de santé. Le projet est
        développé à titre personnel par Matis Gillet (alias <em>mtx_26</em>),
        sans but commercial.
      </p>
      ...
      <ul>
        <li>
          <strong>Email, nom, photo</strong> : via l’authentification (Supabase
          Auth).
        </li>
        <li>
          <strong>Identifiant unique</strong> : généré automatiquement pour
          chaque utilisateur.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Informations sur les boîtes (quantité, stock, conditionnements).
        </li>
      ...
      <ul>
        ...
        <li>
          Informations sur l'appareil et le navigateur (pour le débogage et les
      ...
      <ul>
        ...
        <li>
          Envoyer des rappels ou alertes si l’utilisateur a activé les
          notifications.
        </li>
      ...
      <ul>
        <li>
          <strong>Supabase</strong> (PostgreSQL et authentification).
        </li>
        <li>
          <strong>Firebase</strong> (uniquement pour les notifications push et
          les statistiques anonymes).
        </li>
      </ul>
      <p>
        Les bases de données sont localisées dans l’Union Européenne ou dans des
      ...
      <ul>
        <li>
          <strong>Tous les partages de calendriers</strong> sont chiffrés et
          contrôlés par l’utilisateur.
        </li>
        <li>
          L’accès aux données est <strong>protégé par authentification</strong>.
        </li>
        <li>
          Les identifiants ne sont{' '}
          <strong>jamais visibles ni stockés en clair</strong>.
        </li>
      </ul>
